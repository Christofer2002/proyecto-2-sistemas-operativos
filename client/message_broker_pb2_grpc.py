...
class MessageBrokerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PublishMessage = channel.unary_unary(
                '/message_broker.MessageBrokerService/PublishMessage',
        ...
        self.SubscribeToTopic = channel.unary_stream(
                '/message_broker.MessageBrokerService/SubscribeToTopic',
...
def add_MessageBrokerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SubscribeToTopic': grpc.unary_stream_rpc_method_handler(
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'message_broker.MessageBrokerService', rpc_method_handlers)
...
class MessageBrokerService(object):
    ...
    def PublishMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/message_broker.MessageBrokerService/PublishMessage',
    ...
    def SubscribeToTopic(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/message_broker.MessageBrokerService/SubscribeToTopic',
